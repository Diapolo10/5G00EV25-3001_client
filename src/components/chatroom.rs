...
pub fn chatroom(
    ...
    // Use bottom_up layout to create user message field and send button first and leave the remaining space for the messages
        ...
        ui.horizontal(|ui| {
            ui.add(
                egui::TextEdit::multiline(message)
                    ...
                    .hint_text("Message ".to_owned() + selected_chatroom)
